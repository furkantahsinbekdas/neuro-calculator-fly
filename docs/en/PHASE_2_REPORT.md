<!-- Machine translation of `numcog/RAPOR_FAZ_2.md` (local Ollama / gemma3:4b). The Turkish original is the authoritative record; this file is a reading copy.
     Numeric-token check: PASS (all 184 numeric tokens present) -->
...
artıkça AZALTIR. 1-6 üzerinde öğrenen doğrusal okuma, "büyüklük" vekili olarak bu enerjiyi
...
Özet: KC katmanı aralık içinde neredeyse kayıpsız; aralık dışındaki başarısızlık KC katmanının değil, Gauss kaba kodunun kenar kesilmesinden gelen **ters çevirme**dir.
...
- Mesafe etkisi (H2.3) aralık etkisiyle örtüşüyor; temiz ayrıştırma için aralık-içi mesafe manipülasyonu gerekiyordu (mevcut test setinde aralık içi çiftlerin hepsi d=2,3).
