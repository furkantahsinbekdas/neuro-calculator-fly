...
- Bu keşifsel tanı, Faz 2 sonrası eklenmiştir (post-hoc); sonuçları Faz 2'yi "düzeltmez", Faz 2
  raporu olduğu gibi durur.
...
```
Çıktı: `numcog/results_p2b/` (diagnosis_fn.csv, padding.csv, shared_readout.csv,
range_ablation.csv).
